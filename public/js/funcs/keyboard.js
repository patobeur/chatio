let _keyboard = {
	...
	checkMooves: function () {
		...
		if (_keyboard.actions.moveForward) { _keyboard.moves.y = - 1; _keyboard.actions.ismoving = true; }
		if (_keyboard.actions.moveBackward) { _keyboard.moves.y = 1; _keyboard.actions.ismoving = true; }
		if (_keyboard.actions.moveLeft) { _keyboard.moves.x = - 1; _keyboard.actions.ismoving = true; }
		if (_keyboard.actions.moveRight) { _keyboard.moves.x = 1; _keyboard.actions.ismoving = true; }
	},
	initMoves: function () {
		this.moves = { x: 0, y: 0 }
	},
